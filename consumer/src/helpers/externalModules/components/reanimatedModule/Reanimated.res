...
module LayoutAnimation = {
  ...
  @module("react-native-reanimated")
  external fadeOut: t = "FadeOut"
  @module("react-native-reanimated")
  external fadeOutRight: t = "FadeOutRight"
  @module("react-native-reanimated")
  external fadeOutLeft: t = "FadeOutLeft"
  @module("react-native-reanimated")
  external fadeOutUp: t = "FadeOutUp"
  @module("react-native-reanimated")
  external fadeOutDown: t = "FadeOutDown"
...
@module("react-native-reanimated")
external useDerivedValue: (unit => 't) => SharedValue.t<'t> = "useDerivedValue"
...
@module("react-native-reanimated")
external withTiming: (~toValue: 't, ~userOption: Timing.userOption) => float = "withTiming"

// DO NOT USE OR YOU WILL GET FIRED ;)
@module("react-native-reanimated")
external withTimingWithCallback: (
  ~toValue: 't,
  ~userOption: Timing.userOption,
  ~callback: animationCallback<'t>,
) => float = "withTiming"

module AnimatedReaction = {
  type dependencyList = array<Js.Json.t>

  @module("react-native-reanimated")
  external useAnimatedReaction_: (
    unit => 'a,
    ('a, option<'a>) => unit,
    option<dependencyList>,
  ) => unit = "useAnimatedReaction"
}
let useAnimatedReaction = (
  ~prepare: unit => 'a,
  ~react: ('a, option<'a>) => unit,
  ~dependencies: option<AnimatedReaction.dependencyList>=?,
  (),
) => {
  AnimatedReaction.useAnimatedReaction_(prepare, react, dependencies)
}

//TODO:: Need to evaluate a better method
// module Spring = {
...
// }
//   @module("react-native-reanimated")
//   external withSpring_: ('t, option<config>, option<animationCallback<'t>>) => 't = "withSpring"
// }
...
@module("react-native-reanimated")
external useAnimatedProps: (unit => {..}) => ReactNative.Style.t = "useAnimatedProps"
...
@module("react-native-reanimated") @scope("default")
external createAnimatedComponent: React.component<'p> => React.component<'q> =
  "createAnimatedComponent"

module AnimatedKeyboard = {
  type keyboardState =
    | Unknown
    | Opening
    | Open
    | Closing
    | Closed
  type animatedKeyboardOptions = {isStatusBarTranslucentAndroid?: bool}
  type animatedKeyboardInfo = {
    height: SharedValue.t<float>,
    state: SharedValue.t<keyboardState>,
  }

  @module("react-native-reanimated")
  external useAnimatedKeyboard_: option<bool> => animatedKeyboardInfo = "useAnimatedKeyboard"
}

let useAnimatedKeyboard = (~isStatusBarTranslucentAndroid: option<bool>=?) =>
  AnimatedKeyboard.useAnimatedKeyboard_(isStatusBarTranslucentAndroid)
