...
module KeyboardAwareScrollView = {
  @module("react-native-keyboard-aware-scroll-view") @react.component
  external make: (~children: React.element) => React.element = "KeyboardAwareScrollView"
}
...
module KeyboardAwareFlatList = {
  @module("react-native-keyboard-aware-scroll-view") @react.component
  external make: (
    ~viewIsInsideTabBar: bool=?,
    ~resetScrollToCoords: object=?,
    ~enableAutomaticScroll: bool=?,
    ~extraHeight: float=?,
    ~extraScrollHeight: float=?,
    ~enableResetScrollToCoords: bool=?,
    ~keyboardOpeningTime: float=?,
    ~enableOnAndroid: bool=?,
    // FlatList Props
    ~ref: ref=?,
    // FlatList props
  ...
  ) => React.element = "KeyboardAwareFlatList"
}
