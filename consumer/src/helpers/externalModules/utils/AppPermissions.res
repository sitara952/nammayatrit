...
module Android = {
  ...
  @module("react-native-permissions") @scope(("PERMISSIONS", "ANDROID"))
  external post_notifications: permission = "POST_NOTIFICATIONS"
  @module("react-native-permissions") @scope(("PERMISSIONS", "ANDROID"))
...
external check: permission => Promise.t<permissionStatus> = "check"

@module("react-native-permissions")
external checkMultiple: array<permission> => Promise.t<Dict.t<permissionStatus>> = "checkMultiple"
...
@module("react-native-permissions")
external request: permission => Promise.t<permissionStatus> = "request"

@module("react-native-permissions")
external requestMultiple: array<permission> => Promise.t<Dict.t<permissionStatus>> =
  "requestMultiple"

@module("react-native-permissions")
external requestWithRational: (permission, requestRationale) => Promise.t<permissionStatus> =
  "request"
...
@module("react-native-permissions")
external checkNotifications: unit => Promise.t<requestNotificationsResult> = "checkNotifications"
...
// "provisional"
@module("react-native-permissions")
external requestNotifications: array<string> => Promise.t<requestNotificationsResult> =
  "requestNotifications"

@module("react-native-permissions")
external openSettings: unit => Promise.t<unit> = "openSettings"
