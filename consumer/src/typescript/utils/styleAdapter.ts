import { Falsy, PressableStateCallbackType, RegisteredStyle, StyleProp, StyleSheet, ViewStyle } from 'react-native';
 ...
 * @param {unknown} value - any - The value to check.
 */
...
export const styleAdapter = (
    ...
    touchState: PressableStateCallbackType | undefined,
