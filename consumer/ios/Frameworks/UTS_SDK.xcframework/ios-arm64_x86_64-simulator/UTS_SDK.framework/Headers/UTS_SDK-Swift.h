...
#ifndef UTS_SDK_SWIFT_H
#define UTS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UTS_SDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7UTS_SDK8DemoView")
...
SWIFT_CLASS("_TtC7UTS_SDK13JourneyTicket")
@interface JourneyTicket : UIViewController
- (void)viewDidLoad;
...
@class UIView;
IB_DESIGNABLE
SWIFT_CLASS("_TtC7UTS_SDK12MarqueeLabel")
...
@property (nonatomic) UIContentSizeCategory _Nullable minimumContentSizeCategory SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@property (nonatomic, readonly, copy) NSString * _Nonnull appliedContentSizeCategoryLimitsDescription SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@property (nonatomic) UIContentSizeCategory _Nullable maximumContentSizeCategory SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@end

@class NSURLSession;
@class NSURLAuthenticationChallenge;
@class NSURLCredential;
SWIFT_CLASS("_TtC7UTS_SDK14NetworkService")
...
SWIFT_CLASS("_TtC7UTS_SDK6QrView")
@interface QrView : UIViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC7UTS_SDK13TicketDetails")
@interface TicketDetails : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocationManager;
@class CLLocation;
SWIFT_CLASS("_TtC7UTS_SDK10UTSManager")
@interface UTSManager : NSObject <CLLocationManagerDelegate>
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)manager;
/// CLLocationManager Delegate - Location fetched
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
/// CLLocationManager Delegate - Error
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC7UTS_SDK11ViewFromXib")
