...
public class PdfConverter implements Runnable {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT)
                    Log.e(TAG, "call requires API level 19");
                else {
                    ...
                    ParcelFileDescriptor fileDescriptor = getOutputFileDescriptor();
                    if (fileDescriptor == null) return;
                    documentAdapter.onWrite(new PageRange[]{PageRange.ALL_PAGES}, fileDescriptor, null, new PrintDocumentAdapter.WriteResultCallback() {
                        @Override
    ...
    public void convert(Context context, String htmlString, File file, boolean shouldEncode, WritableMap resultMap,
        ...
        if (htmlString == null)
            Log.e(TAG, "htmlString can't be null");
        if (file == null)
            Log.e(TAG, "file can't be null");
